...
@section('link', route('superadmin.features.create'))
                    ...
                    <tr class="item">
                        ...
                        <td>
                            <div class="vironeer-content-box">
                                <a class="vironeer-content-image" href="{{ route('superadmin.features.edit', $feature->id) }}">
                                    <img src="{{ asset($feature->image) }}">
                                </a>
                                <div>
                                    <a class="text-reset"
                                        href="{{ route('superadmin.features.edit', $feature->id) }}">{{ shortertext($feature->title, 40) }}</a>
                                ...
                                <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ route('superadmin.features.edit', $feature->id) }}"><i

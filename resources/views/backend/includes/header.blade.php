<header class="vironeer-page-header">
        ...
        <div class="vironeer-notifications-menu">
            <div class="vironeer-notifications-header">
                ...
                @if ($unreadAdminNotifications)
                    <a href="{{ route('superadmin.notifications.readall') }}"
                ...
                @forelse ($adminNotifications as $adminNotification)
                    @if ($adminNotification->link)
                        <a class="vironeer-notification"
                            href="{{ route('superadmin.notifications.view', hashid($adminNotification->id)) }}">
            ...
            <a class="vironeer-notifications-footer" href="{{ route('superadmin.notifications.index') }}">
                {{ __('View All') }}
            </a>
        </div>
    </div>
    ...
    <div class="vironeer-user-menu">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <li><a class="dropdown-item" href="{{ route('superadmin.account.details') }}"><i
                        class="fa fa-edit me-2"></i>{{ __('Details') }}</a></li>
            <li><a class="dropdown-item" href="{{ route('superadmin.account.security') }}"><i

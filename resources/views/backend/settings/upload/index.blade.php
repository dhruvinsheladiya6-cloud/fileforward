            ...
            <tbody>
                @foreach ($uploadSettings as $uploadSetting)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('superadmin.settings.upload.edit', $uploadSetting->id) }}">
                                <img src="{{ asset($uploadSetting->icon) }}" height="40" width="40">
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('superadmin.settings.upload.edit', $uploadSetting->id) }}" class="text-dark">
                                {{ $uploadSetting->name }}
                            </a>
                        </td>
                                ...
                                <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ route('superadmin.settings.upload.edit', $uploadSetting->id) }}"><i

            ...
            <tbody>
                @foreach ($storageProviders as $storageProvider)
                    <tr class="item">
                        ...
                        <td>
                            <a href="{{ route('superadmin.settings.storage.edit', $storageProvider->id) }}">
                                <img src="{{ asset($storageProvider->logo) }}" height="40" width="40">
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('superadmin.settings.storage.edit', $storageProvider->id) }}" class="text-dark">
                        ...
                        <td>
                            <div class="text-end">
                                ...
                                <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                    @if ($storageProvider->symbol != 'local')
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('superadmin.settings.storage.edit', $storageProvider->id) }}"><i
                                    ...
                                    @endif
                                    <li>
                                        <form action="{{ route('superadmin.settings.storage.default', $storageProvider->id) }}"
                                            method="POST">
                                            @csrf

            ...
            @foreach ($groups as $group)
                <li>
                    <a class="dropdown-item capitalize {{ $activeGroup == $group->group_name ? 'active' : '' }}"
                        href="{{ route('superadmin.settings.mailtemplates.show.group', [$language->code, str_replace(' ', '-', $group->group_name)]) }}">
    ...
    <div class="card custom-card">
        <div class="card-body">
            <form id="vironeer-submited-form"
                action="{{ route('superadmin.settings.mailtemplates.update', [$language->code, str_replace(' ', '-', $activeGroup)]) }}"
                method="POST">
                @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="mailSettingsForm" action="{{ route('superadmin.settings.mailtemplates.settings.update') }}"

            ...
            <tbody>
                @foreach ($gateways as $gateway)
                    <tr class="item">
                        <td>{{ $gateway->id }}</td>
                        <td>
                            <a href="{{ route('superadmin.settings.gateways.edit', $gateway->id) }}" class="text-dark">
                                {{ $gateway->name }}
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('superadmin.settings.gateways.edit', $gateway->id) }}">
                                ...
                                <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ route('superadmin.settings.gateways.edit', $gateway->id) }}"><i

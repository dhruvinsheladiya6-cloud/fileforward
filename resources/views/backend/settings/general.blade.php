...
@section('content')
    <form id="vironeer-submited-form" action="{{ route('superadmin.settings.general.update') }}" method="POST"
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="ul mb-3">
                    <li class="mb-1">
                        <strong>{{ __('Unacceptable file types') }}</strong> :
                        {{ __('Make sure you enter the correct file formats to prevent uploading them.') }}
                    </li>
                    <li class="mb-1"><strong>{{ __('Chunk size') }}</strong> :
                        {{ __('Minimum chunk size 1MB and we recommended 50 or 90.') }}</li>
                    <li class="mb-1"><strong>{{ __('Download waiting time') }}</strong>
                        : {{ __('You can set the download waiting time as 0 to disable it.') }}</li>
                    <li><strong>{{ __('Download links expire after') }}</strong> :
                        {{ __('means when the direct links expire, not download page links, (5 minutes minimum).') }}
                    </li>
                </div>
                <div class="row g-3">
                    <div class="col-lg-12">
                        ...
                        <input type="text" name="unacceptable_file_types" class="tagsInput form-control"
                            placeholder="{{ __('Enter mime type') }}" value="{{ $settings['unacceptable_file_types'] }}">
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <label class="form-label">{{ __('Download links expire after') }} : <span
                                class="red">*</span></label>
                        <div class="custom-input-group input-group">
                            <input type="number" name="download_link_validity_time" class="form-control" min="5"
                                value="{{ $settings['download_link_validity_time'] }}">
                            <span class="input-group-text"><i
                                    class="far fa-clock me-2"></i><strong>{{ __('Minutes') }}</strong></span>
                        </div>
                    </div>
                    <div class="col-lg-3">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-lg-3 col-xl-3">
                        <label class="form-label">{{ __('Website Registration') }} : </label>

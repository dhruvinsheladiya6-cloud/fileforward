...
@section('back', route('superadmin.settings.taxes.index'))
@section('container', 'container-max-lg')
@section('content')
    <form id="vironeer-submited-form" action="{{ route('superadmin.settings.taxes.update', $tax->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="card-body">
                <div class="row g-3 mb-2">
                    <div class="col-lg-6">
                        ...
                        <select name="country_id" class="form-select select2" required>
                            <option></option>
                            <option value="0" {{ !$tax->country_id ? 'selected' : '' }}>{{ __('All countries') }}
                            </option>
                    ...
                    <div class="col-lg-6">
                        <label class="form-label">{{ __('Tax percentage') }} : <span

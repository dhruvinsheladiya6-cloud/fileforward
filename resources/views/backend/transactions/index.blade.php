                    ...
                    <tbody>
                        @foreach ($paidTransactions as $paidTransaction)
                            <tr>
                                ...
                                <td><a
                                        href="{{ route('superadmin.transactions.edit', $paidTransaction->id) }}">#{{ $paidTransaction->transaction_id }}</a>
                                </td>
                                <td><a href="{{ route('superadmin.users.edit', $paidTransaction->user->id) }}"
                                        class="text-dark"><i class="fa fa-user me-2"></i>
                                        {{ $paidTransaction->user->firstname . ' ' . $paidTransaction->user->lastname }}
                                    </a>
                                </td>
                                <td><a href="{{ route('superadmin.plans.edit', $paidTransaction->plan->id) }}"
                                ...
                                <td>
                                    {!! $paidTransaction->gateway ? '<a href="' . route('superadmin.settings.gateways.edit', $paidTransaction->gateway->id) . '" class="text-dark"><i class="fas fa-external-link-alt me-2"></i>' . $paidTransaction->gateway->name . '</a>' : '--' !!}
                                </td>
                                <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.transactions.edit', $paidTransaction->id) }}"><i
                                            ...
                                            <li>
                                                <form
                                                    action="{{ route('superadmin.transactions.destroy', $paidTransaction->id) }}"
                                                    method="POST">
                                                    @csrf @method('DELETE')
                        ...
                        <tbody>
                            @foreach ($freeTransactions as $freeTransaction)
                                <tr>
                                    ...
                                    <td><a
                                            href="{{ route('superadmin.transactions.edit', $freeTransaction->id) }}">#{{ $freeTransaction->transaction_id }}</a>
                                    </td>
                                    <td><a href="{{ route('superadmin.users.edit', $freeTransaction->user->id) }}"
                                            class="text-dark"><i class="fa fa-user me-2"></i>
                                            {{ $freeTransaction->user->firstname . ' ' . $freeTransaction->user->lastname }}
                                        </a>
                                    </td>
                                    <td><a href="{{ route('superadmin.plans.edit', $freeTransaction->plan->id) }}"
                                    ...
                                    <td>
                                        <div class="text-end">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-sm-end"
                                                ...
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('superadmin.transactions.edit', $freeTransaction->id) }}"><i
                                                            class="fa fa-edit me-2"></i>{{ __('Edit') }}</a>
                                                </li>
                                                <li>
                                                    <hr class="dropdown-divider" />
                                                ...
                                                <li>
                                                    <form
                                                        action="{{ route('superadmin.transactions.destroy', $freeTransaction->id) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
                                                        <button
                        ...
                        <tbody>
                            @foreach ($usesCouponTransactions as $usesCouponTransaction)
                                <tr>
                                    ...
                                    <td><a
                                            href="{{ route('superadmin.transactions.edit', $usesCouponTransaction->id) }}">#{{ $usesCouponTransaction->transaction_id }}</a>
                                    </td>
                                    <td><a href="{{ route('superadmin.users.edit', $usesCouponTransaction->user->id) }}"
                                            class="text-dark"><i class="fa fa-user me-2"></i>
                                            {{ $usesCouponTransaction->user->firstname . ' ' . $usesCouponTransaction->user->lastname }}
                                        </a>
                                    </td>
                                    <td><a href="{{ route('superadmin.plans.edit', $usesCouponTransaction->plan->id) }}"
                                    ...
                                    <td>
                                        @if (!$usesCouponTransaction->coupon->deleted_at)
                                            <a href="{{ route('superadmin.coupons.edit', $usesCouponTransaction->coupon->id) }}"
                                                class="text-dark">
                                                <i
                                    ...
                                    <td>
                                        {!! $usesCouponTransaction->gateway ? '<a href="' . route('superadmin.settings.gateways.edit', $usesCouponTransaction->gateway->id) . '" class="text-dark"><i class="fas fa-external-link-alt me-2"></i>' . $usesCouponTransaction->gateway->name . '</a>' : '--' !!}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="text-end">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-sm-end"
                                                ...
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('superadmin.transactions.edit', $usesCouponTransaction->id) }}"><i
                                                            class="fa fa-edit me-2"></i>{{ __('Edit') }}</a>
                                                </li>
                                                <li>
                                                    <hr class="dropdown-divider" />
                                                ...
                                                <li>
                                                    <form
                                                        action="{{ route('superadmin.transactions.destroy', $usesCouponTransaction->id) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
                                                        <button
                                                            class="vironeer-able-to-delete dropdown-item text-danger"><i
                    ...
                    <tbody>
                        @foreach ($canceledTransactions as $canceledTransaction)
                            <tr>
                                ...
                                <td><a
                                        href="{{ route('superadmin.transactions.edit', $canceledTransaction->id) }}">#{{ $canceledTransaction->transaction_id }}</a>
                                </td>
                                <td><a href="{{ route('superadmin.users.edit', $canceledTransaction->user->id) }}"
                                        class="text-dark"><i class="fa fa-user me-2"></i>
                                        {{ $canceledTransaction->user->firstname . ' ' . $canceledTransaction->user->lastname }}
                                    </a>
                                </td>
                                <td><a href="{{ route('superadmin.plans.edit', $canceledTransaction->plan->id) }}"
                                ...
                                <td>
                                    {!! $canceledTransaction->gateway ? '<a href="' . route('superadmin.settings.gateways.edit', $canceledTransaction->gateway->id) . '" class="text-dark"><i class="fas fa-external-link-alt me-2"></i>' . $canceledTransaction->gateway->name . '</a>' : '--' !!}
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="text-end">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.transactions.edit', $canceledTransaction->id) }}"><i
                                            ...
                                            <li>
                                                <form
                                                    action="{{ route('superadmin.transactions.destroy', $canceledTransaction->id) }}"
                                                    method="POST">
                                                    @csrf @method('DELETE')
                                                    <button class="vironeer-able-to-delete dropdown-item text-danger"><i
                                                            class="far fa-trash-alt me-2"></i>{{ __('Delete') }}</button>

...
@section('link', route('superadmin.coupons.create'))
@section('content')
                    ...
                    <tr>
                        ...
                        <td>
                            @if (!is_null($coupon->plan_id))
                                <a href="{{ route('superadmin.plans.edit', $coupon->plan->id) }}"
                                    style="color: {{ $coupon->plan->color }}"><i class="far fa-gem me-2"></i>
                                    {{ $coupon->plan->name }}
                                </a>
                            @else
                                <a href="{{ route('superadmin.plans.index') }}" class="text-dark">
                                ...
                                <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ route('superadmin.coupons.edit', $coupon->id) }}"><i

            ...
            <div class="col-12 col-lg-4 col-xxl">
                <div class="vironeer-counter-card bg-c-4">
                    ...
                    <div class="vironeer-counter-card-meta">
                        <p class="vironeer-counter-card-title">{{ __('Active Subscriptions') }}</p>
                        <p class="vironeer-counter-card-number">{{ count($activeSubscriptions) }}</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-4 col-xxl">
                <div class="vironeer-counter-card bg-c-7">
                    ...
                    <div class="vironeer-counter-card-meta">
                        <p class="vironeer-counter-card-title">{{ __('Expired Subscriptions') }}</p>
                        <p class="vironeer-counter-card-number">{{ count($expiredSubscriptions) }}</p>
                    </div>
                </div>
            </div>
        </div>
        @if (count($canceledSubscriptions) > 0)
            <div class="col-12 col-lg-6 col-xxl">
                <div class="vironeer-counter-card bg-c-7">
                    ...
                    <div class="vironeer-counter-card-meta">
                        <p class="vironeer-counter-card-title">{{ __('Canceled Subscriptions') }}</p>
                        <p class="vironeer-counter-card-number">{{ count($canceledSubscriptions) }}</p>
                    </div>
                </div>
            </div>
        @endif
                    ...
                    <tbody>
                        @foreach ($activeSubscriptions as $activeSubscription)
                            <tr>
                                ...
                                <td>
                                    <div class="vironeer-user-box">
                                        <a class="vironeer-user-avatar"
                                            href="{{ route('superadmin.users.edit', $activeSubscription->user->id) }}">
                                ...
                                <td><a href="{{ route('superadmin.plans.edit', $activeSubscription->plan->id) }}"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-sm-end dropdown-menu-lg"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.subscriptions.edit', $activeSubscription->id) }}"><i
                                                        class="fa fa-edit me-2"></i>{{ __('Edit') }}</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.users.edit', $activeSubscription->user->id) }}"><i
                                            ...
                                            <li>
                                                <form
                                                    action="{{ route('superadmin.subscriptions.destroy', $activeSubscription->id) }}"
                                                    method="POST">
                                                    @csrf @method('DELETE')
                        ...
                        @foreach ($expiredSubscriptions as $expiredSubscription)
                            <tr>
                                ...
                                <td>
                                    <div class="vironeer-user-box">
                                        <a class="vironeer-user-avatar"
                                            href="{{ route('superadmin.users.edit', $expiredSubscription->user->id) }}">
                                ...
                                <td><a href="{{ route('superadmin.plans.edit', $expiredSubscription->plan->id) }}"
                                ...
                                <td>
                                    <div class="text-end">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-sm-end dropdown-menu-lg"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.subscriptions.edit', $expiredSubscription->id) }}"><i
                                                        class="fa fa-edit me-2"></i>{{ __('Edit') }}</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.users.edit', $expiredSubscription->user->id) }}"><i
                                                        class="fa fa-user me-2"></i>{{ __('User details') }}</a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider" />
                                            ...
                                            <li>
                                                <form
                                                    action="{{ route('superadmin.subscriptions.destroy', $expiredSubscription->id) }}"
                                                    method="POST">
                                                    @csrf @method('DELETE')
                                                    <button class="vironeer-able-to-delete dropdown-item text-danger"><i
                                                            class="far fa-trash-alt me-2"></i>{{ __('Delete') }}</button>
                            ...
                            @foreach ($canceledSubscriptions as $canceledSubscription)
                                <tr>
                                    ...
                                    <td>
                                        <div class="vironeer-user-box">
                                            <a class="vironeer-user-avatar"
                                                href="{{ route('superadmin.users.edit', $canceledSubscription->user->id) }}">
                                    ...
                                    <td><a href="{{ route('superadmin.plans.edit', $canceledSubscription->plan->id) }}"
                                    ...
                                    <td>
                                        <div class="text-end">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-sm-end dropdown-menu-lg"
                                                ...
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('superadmin.subscriptions.edit', $canceledSubscription->id) }}"><i
                                                            class="fa fa-edit me-2"></i>{{ __('Edit') }}</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('superadmin.users.edit', $canceledSubscription->user->id) }}"><i
                                                            class="fa fa-user me-2"></i>{{ __('User details') }}</a>
                                                </li>
                                                <li>
                                                    <hr class="dropdown-divider" />
                                                ...
                                                <li>
                                                    <form
                                                        action="{{ route('superadmin.subscriptions.destroy', $canceledSubscription->id) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
                                                        <button

...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <form id="vironeer-submited-form" action="{{ route('superadmin.users.update', $user->id) }}" method="POST">
                @csrf
                @method('PUT')
    ...
    <div class="modal fade" id="sendMailModal" tabindex="-1" aria-labelledby="sendMailModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form action="{{ route('superadmin.users.sendmail', $user->id) }}" method="POST">
                    @csrf

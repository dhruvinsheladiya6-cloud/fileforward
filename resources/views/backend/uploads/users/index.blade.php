...
@section('content')
    ...
    <div class="custom-card card">
        <div class="card-header p-3 border-bottom-small">
            ...
            <form class="multiple-select-delete-form d-none" action="{{ route('superadmin.uploads.users.destroy.selected') }}"
                method="POST">
                @csrf
                                    ...
                                    <td>
                                        <div class="vironeer-content-box">
                                            <a class="vironeer-content-image text-center"
                                                href="{{ route('superadmin.uploads.users.view', $fileEntry->shared_id) }}">
                                            ...
                                            <div>
                                                <a class="text-reset"
                                                    href="{{ route('superadmin.uploads.users.view', $fileEntry->shared_id) }}">{{ shortertext($fileEntry->name, 50) }}</a>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-md-end dropdown-menu-lg"
                                                ...
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('superadmin.uploads.users.download', $fileEntry->shared_id) }}"><i
                                                            class="fas fa-download me-2"></i>{{ __('Download') }}</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('superadmin.uploads.users.view', $fileEntry->shared_id) }}"><i
                                                ...
                                                <li>
                                                    <form
                                                        action="{{ route('superadmin.uploads.users.destroy', $fileEntry->shared_id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button

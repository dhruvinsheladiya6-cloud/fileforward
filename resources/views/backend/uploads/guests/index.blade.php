...
@section('content')
    <div class="row g-3 mb-4">
        ...
        <div class="col-12 col-lg-4 col-xxl">
            <div class="vironeer-counter-card bg-dark">
                <div class="vironeer-counter-card-icon">
    ...
    <div class="custom-card card">
        <div class="card-header p-3 border-bottom-small">
            ...
            <form class="multiple-select-delete-form d-none" action="{{ route('superadmin.uploads.guests.destroy.selected') }}"
                method="POST">
                @csrf
                                    ...
                                    <td>
                                        <div class="vironeer-content-box">
                                            <a class="vironeer-content-image text-center"
                                                href="{{ route('superadmin.uploads.guests.view', $fileEntry->shared_id) }}">
                                                @if ($fileEntry->type == 'image')
                                                    <img src="{{ route('superadmin.uploads.secure', hashid($fileEntry->id)) }}"
                                                        alt="{{ $fileEntry->name }}">
                                                @else
                                            ...
                                            <div>
                                                <a class="text-reset"
                                                    href="{{ route('superadmin.uploads.guests.view', $fileEntry->shared_id) }}">{{ shortertext($fileEntry->name, 50) }}</a>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <a class="text-dark capitalize"
                                                href="{{ route('superadmin.settings.storage.edit', $fileEntry->storageProvider->id) }}">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-md-end dropdown-menu-lg"
                                                ...
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('superadmin.uploads.guests.download', $fileEntry->shared_id) }}"><i
                                                            class="fas fa-download me-2"></i>{{ __('Download') }}</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('superadmin.uploads.guests.view', $fileEntry->shared_id) }}"><i
                                                ...
                                                <li>
                                                    <form
                                                        action="{{ route('superadmin.uploads.guests.destroy', $fileEntry->shared_id) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
                                                        <button

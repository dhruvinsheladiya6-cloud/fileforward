                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item"
                                                href="{{ route('superadmin.settings.general') }}">{{ __('General Settings') }}</a>
                                        </li>
                                        @if (licenseType(1))
                                            <li><a class="dropdown-item"
                                                    href="{{ route('superadmin.settings.upload.index') }}">{{ __('Upload Settings') }}</a>
                                            </li>
                                        @endif
                                        <li><a class="dropdown-item"
                                                href="{{ route('superadmin.settings.smtp') }}">{{ __('SMTP Settings') }}</a>
                                        </li>
                                        <li><a class="dropdown-item"

...
@section('link', route('superadmin.plans.create'))
@section('content')
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.plans.edit', $monthlyPlan->id) }}"><i
                                            ...
                                            <li>
                                                <form action="{{ route('superadmin.plans.destroy', $monthlyPlan->id) }}"
                                                    method="POST">
                                                    @csrf @method('DELETE')
                                ...
                                <td>
                                    <div class="text-end">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.plans.edit', $yearlyPlan->id) }}"><i
                                                        class="fa fa-edit me-2"></i>{{ __('Edit') }}</a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider" />
                                            ...
                                            <li>
                                                <form action="{{ route('superadmin.plans.destroy', $yearlyPlan->id) }}"
                                                    method="POST">
                                                    @csrf @method('DELETE')
                                                    <button class="vironeer-able-to-delete dropdown-item text-danger"><i
                                                            class="far fa-trash-alt me-2"></i>{{ __('Delete') }}</button>
                                ...
                                <td>
                                    <div class="text-end">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('superadmin.plans.edit', $lifetimePlan->id) }}"><i
                                                        class="fa fa-edit me-2"></i>{{ __('Edit') }}</a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider" />
                                            ...
                                            <li>
                                                <form action="{{ route('superadmin.plans.destroy', $lifetimePlan->id) }}"
                                                    method="POST">
                                                    @csrf @method('DELETE')
                                                    <button class="vironeer-able-to-delete dropdown-item text-danger"><i
                                                            class="far fa-trash-alt me-2"></i>{{ __('Delete') }}</button>

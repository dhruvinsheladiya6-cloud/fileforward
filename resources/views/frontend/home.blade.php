...
<head>
    ...
    @push('styles_libs')
        ...
        <link rel="stylesheet" href="{{ asset('assets/css/extrachange.css') }}">
...
<body>
            ...
            <div class="header-content text-center">
                <div class="container">
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="750">
                        ...
                        @else
                            <button class="btn btn-primary btn-lg px-5 upload-file-option js-direct-upload" href="#" id="directUploadBtn">
                                <i class="fa fa-cloud-upload-alt fa-sm me-1"></i>
                                {{ lang('Upload', 'home page') }}
                            </button>
                        @endif
                        ...
                        <div class="accordion-item shadow-sm border-0">
                            <h2 class="accordion-header" id="heading{{ hashid($faq->id) }}">
                                <button class="accordion-button {{ $loop->first ? '' : 'collapsed' }}" type="button"
                                    ...
                                    aria-expanded="false" aria-controls="collapse{{ hashid($faq->id) }}">
                                    {{ $faq->title }}
                                </button>
                            </h2>
    ...
    @push('scripts_libs')
        ...
        <script src="{{ asset('assets/js/extrachange.js') }}"></script>
    @endpush

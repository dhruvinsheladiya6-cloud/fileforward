...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function sharedEntries()   // items shared to me
    {
        return $this->belongsToMany(FileEntry::class, 'file_entry_shares', 'recipient_user_id', 'file_entry_id')
                    ->withPivot(['permission','can_download','can_reshare','id','created_at'])
                    ->whereNull('file_entry_shares.revoked_at');
    }

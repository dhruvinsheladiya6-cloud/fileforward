...
// shared edit/update
                ...
                Route::prefix('file-requests')->name('file-requests.')->group(function () {
                    Route::get('/', 'FileRequestController@index')->name('index');
                    Route::post('/', 'FileRequestController@store')->name('store'); // /user/file-requests
                    Route::get('folders', 'FileRequestController@getFolders')->name('folders'); // Get folders for picker
                    Route::get('{fileRequest}', 'FileRequestController@show')->name('show');
                    Route::put('{fileRequest}', 'FileRequestController@update')->name('update');
                    Route::post('{fileRequest}/close', 'FileRequestController@close')->name('close');
                    Route::post('{fileRequest}/share', 'FileRequestController@sendInvites')->name('share');
                });
...
Route::group(['namespace' => 'Frontend'], function () {
    ...
    Route::post('request/{token}/unlock', 'PublicFileRequestController@unlock')->name('file-request.unlock');
});

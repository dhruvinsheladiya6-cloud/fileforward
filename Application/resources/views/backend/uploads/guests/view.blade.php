...
@section('back', route('superadmin.uploads.guests.index'))
@section('content')
    <div class="row g-3">
        <div class="col-lg-8">
            <div class="card">
            ...
            <div class="card">
                <ul class="custom-list-group list-group list-group-flush">
                    <li class="list-group-item">
                        ...
                        <a href="{{ route('superadmin.uploads.guests.download', $fileEntry->shared_id) }}"
                            class="btn btn-success btn-lg w-100 mb-3"><i
                                class="fas fa-download me-2"></i>{{ __('Download') }}</a>
                        <form action="{{ route('superadmin.uploads.guests.destroy', $fileEntry->shared_id) }}" method="POST">
                            @csrf @method('DELETE')

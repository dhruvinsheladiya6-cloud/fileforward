...
@section('back', route('superadmin.transactions.index'))
@section('content')
            ...
            <div class="card custom-card">
                ...
                <ul class="custom-list-group list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                        ...
                        <span><a href="{{ route('superadmin.users.edit', $transaction->user->id) }}" class="text-dark"><i
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                        ...
                        <span><a href="{{ route('superadmin.plans.edit', $transaction->plan->id) }}"
                    ...
                    @if ($transaction->gateway)
                        <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                            ...
                            <span><a href="{{ route('superadmin.settings.gateways.edit', $transaction->gateway->id) }}"
                                    class="text-dark"><i
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                            ...
                            <span>
                                @if (!$transaction->coupon->deleted_at)
                                    <a href="{{ route('superadmin.coupons.edit', $transaction->coupon->id) }}">

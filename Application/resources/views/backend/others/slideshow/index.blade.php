...
@section('link', route('superadmin.slideshow.create'))
                                ...
                                <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ route('superadmin.slideshow.edit', $slideshow->id) }}"><i
                                    ...
                                    <li>
                                        <form action="{{ route('superadmin.slideshow.destroy', $slideshow->id) }}"
                                            method="POST">
                                            @csrf @method('DELETE')

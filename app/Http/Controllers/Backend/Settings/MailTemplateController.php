...
class MailTemplateController extends Controller
{
    ...
    {
        return redirect()->route('superadmin.settings.mailtemplates.show', env('DEFAULT_LANGUAGE'));
    }

    public function index(Request $request, $lang, $group = null)
    {
        if ($request->has('lang')) {
            return redirect()->route('superadmin.settings.mailtemplates.show', $request->lang);
        }
